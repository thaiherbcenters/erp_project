...
- **แก้ไข Sticky Position ของบล็อกสรุปยอดเงินด้านขวา**:
  - เปลี่ยนระยะ `top` จาก `20px` เป็น `88px` เพื่อให้เว้นระยะหลบแถบเมนูด้านบน (Top Navbar สูง 72px) เมื่อเลื่อนหน้าจอ (Scroll) ลงมา
  - หัวการ์ด **"สรุปยอดเงิน (บาท)"** และปุ่มคำสั่งจะยังคงลอยเด่นอยู่ด้านล่างแถบเมนูอย่างสมบูรณ์ ไม่ถูกแถบเมนูด้านบนบดบังหรือหายไปอีกต่อไป
- ปรับขนาด `@page`: เปลี่ยนเป็น `margin: 5mm 9.5mm` เพื่อดึงขอบเข้ามาประมาณ 3-3.5mm ตามที่ต้องการ ให้มีระยะหายใจที่พอดี ไม่ชิดขอบกระดาษจนเกินไป
