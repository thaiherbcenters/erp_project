/**
 * validators/taxInvoices.js — Zod schemas สำหรับ tax invoice routes
 */
const { z } = require('zod');
...
const createTaxInvoiceSchema = z.object({
    ...
    items: z.array(taxInvoiceItemSchema).optional().default([]),
});
...
module.exports = { createTaxInvoiceSchema, updateStatusSchema };
