/**
 * validators/billingInvoices.js — Zod schemas สำหรับ billing invoice routes
 */
const { z } = require('zod');

const billingInvoiceItemSchema = z.object({
...
const createBillingInvoiceSchema = z.object({
    ...
    billingInvoiceNo: z.string().optional(),
    ...
    items: z.array(billingInvoiceItemSchema).optional().default([]),
});
...
module.exports = { createBillingInvoiceSchema, updateStatusSchema };
