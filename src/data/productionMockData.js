...
export const PRODUCTION_STEPS = [
    ...
    { key: 'packaging',      label: 'บรรจุภัณฑ์',          shortLabel: 'Packaging',      icon: 'Package',     description: 'บรรจุผลิตภัณฑ์ลงภาชนะ' },
    { key: 'labeling',       label: 'งานติดฉลาก',          shortLabel: 'Labeling',       icon: 'Tag',         description: 'ติดฉลากและสติ๊กเกอร์' },
