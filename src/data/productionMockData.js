...
export const PRODUCTION_STEPS = [
    ...
    { key: 'prepare',        label: 'เตรียม + ผสม',        shortLabel: 'เตรียม + ผสม',   icon: 'ListChecks',  description: 'เตรียมวัตถุดิบและอุปกรณ์' },
    { key: 'production_1',   label: 'ผลิตขั้นตอนที่ 1',    shortLabel: 'In Progress 1',  icon: 'Play',        description: 'ผสม / ขึ้นรูป' },
