...
export default function PermissionManager() {
    ...
    const fetchUsers = async () => {
        ...
        try {
            const res = await fetch('http://61.7.209.84:5000/api/users');
            if (res.ok) {
    ...
    useEffect(() => {
        ...
        fetch('http://61.7.209.84:5000/api/departments')
    ...
    const handleDeleteUser = async (userId, userName) => {
        ...
        try {
            const res = await fetch(`http://61.7.209.84:5000/api/users/${userId}`, {
                method: 'DELETE',
            });
